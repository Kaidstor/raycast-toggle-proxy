   ...
   async function checkTmuxInstalled() {
      try {
         ...
         try {
            ...
            fs.appendFileSync(path.join(logPath, "tmux-check.log"),
            ...
            if (!isProxyRunning) {
               ...
               try {
                  ...
                  if (isProxyRunning) {
                     ...
                     fs.appendFileSync(path.join(logPath, "proxy-errors.log"),
   ...
   return (
      ...
      >
         ...
         {isTmuxInstalled === false && (
            <MenuBarExtra.Item
               title="Tmux не установлен"
               tooltip="Установите tmux для работы прокси"
            />
         )}
      </MenuBarExtra>
   );
